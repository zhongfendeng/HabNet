# HabNet
The code and data are only used for reviewing paper 'Hierarchical Bi-Directional Self-Attention Networks for Paper Review Rating Recommendation'. They will be made public only after this paper being accepted for COLING 2020.
