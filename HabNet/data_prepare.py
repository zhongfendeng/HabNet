...
def build_vocab(docs, save_path):
    ...
    for ind, text in enumerate(docs):
        print(str(ind) + " text: "+text)
        temp_sents = nltk.sent_tokenize(text)
        sents += temp_sents
    '''
...
def read_data(data_file):
    ...
    #dev_data = data.iloc[7600:8600, :]
    #test_data = data.iloc[8600:9600, :]
...
if __name__ == '__main__':
    ...
    #word_to_index = read_vocab('data/ICLR_Review_all-w2i.pkl')
